  ...
  render() {
    ...
    return (
      <div>
        ...
        <Row>
          <Col className="center-align py-2" sm={{ span: 6, offset: 4 }}>
            <ReactSpeedometer
              maxValue={40}
              value={speed}
              needleColor="red"
        ...
        <div class="center-align">
          ...
          <Row>
            <Label
              svgSrc="./temperature.svg"
              label="High Temp"
              value={stateOfCharge + " V"}
            />
          ...
          <Row>
            ...
            />
            <Label
              label="Pack current charge limit"
              value={consumption + " V"}
            />
            <Label
          ...
          <Row>
            <Label
              svgSrc="./solar-power.svg"
              label="Fail Safe Status"
              value={panelPower + " V"}
            />
          </Row>
        </div>
